...
/**
 * abort a fetch() request by providing it with an AbortController signal:fetch('url', { signal: controller.signal });  call the controller.abort() method to abort the request.
 */
...
export async function getDirectAvatarForUser(
